...
.avatar{
  ...
  background:linear-gradient(160deg, var(--accent) 0%, var(--brand-pink) 100%);
  border:2px solid #fff; box-shadow:0 0 0 2px var(--success);
  margin-left:6px;
}
...
.hero p{ margin:0; color:#6D6B77; font-size:15px; line-height:1.55; max-width:470px; }
.hero .cta{
...
.hero-portrait img{ position:absolute; left:50%; transform:translateX(-50%); top:20px; height:500px; width:auto; }
@media(max-width:900px){ .hero-portrait{ width:180px; } .hero-portrait img{ height:380px; top:14px; } }
